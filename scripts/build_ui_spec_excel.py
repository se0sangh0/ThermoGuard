...
FUNCTIONS = {
    ...
    "알림팝업/조회 범위": "ProductDashboard._on_alert_period_changed",
    ...
    "그래프팝업/조회 범위": "ProductDashboard._on_trend_period_changed",
...
INTERFACES = {
    ...
    "하단/미확인 알림": "Tkinter command → GET /api/alerts?hours={1|24|72|168}",
    "하단/온도 추이": "Tkinter command → GET /api/temperature-trend?hours={1|24|72|168}",
    ...
    "알림팝업/조회 범위": "Tkinter Combobox → hours=1|24|72|168",
    "알림팝업/필터": "로컬 메모리 필터 · 통신 없음",
    "알림팝업/새로고침": "HTTP GET /api/alerts?hours={1|24|72|168}&limit=5000 → alert_events",
    "알림팝업/알림 목록": "REST JSON → Tkinter Treeview",
    "알림팝업/선택 알림 확인 처리": "HTTP PATCH /api/alerts/{alert_id} → alert_events",
    "그래프팝업/조회 범위": "Tkinter Combobox → GET /api/temperature-trend?hours={1|24|72|168}",
    ...
    "데이터연동/알림 이력 조회": "HTTP GET /api/alerts?hours={1|24|72|168} → alert_events",
    "데이터연동/알림 확인 처리": "HTTP PATCH /api/alerts/{alert_id} → alert_events",
    "데이터연동/온도 이력 조회": "HTTP GET /api/temperature-trend?hours={1|24|72|168} → roi_measurements",
